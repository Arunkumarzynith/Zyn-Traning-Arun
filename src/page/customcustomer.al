    ...
    layout
    {
        area(Content)
        {
            ...
            group(SalesGroup)
            {
                ...
                part("Linking Sales Order"; "cust customer list part")
                {
                    ApplicationArea = All;
            ...
            group(LinkingGroup)
            {
                part("Linking Sales Invoice"; "Cust Customer List Part")
                {
                    ApplicationArea = All;
            ...
            {
                part("Linking Sales Credit Memo"; "Cust Customer List Part")
                {
                    ApplicationArea = All;
