table 50352 "Emp Assets"
{
    ...
    fields
    {
        ...
        {
            DataClassification=ToBeClassified;
            TableRelation="Assets Table".SerialNo;
        }
        field(4;Status;Enum "asset Status")
        {
            DataClassification=ToBeClassified;
            trigger OnValidate()
            var
                AssetsRec: Record "Assets Table";
                PrevEmpAsset: Record "Emp Assets";
                ExpiryDate: Date;
            begin
                ...
                if Rec.Status = Status::Assgned then begin
                ...
                end else if Rec.Status = Status::retruned then begin
                    ...
                    PrevEmpAsset.SetRange(Status, Status::Assgned);
